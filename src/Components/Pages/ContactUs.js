                            ...
                            <div className="lg:col-span-4 xmd:col-span-4 md:col-span-4 xsm:col-span-4 sm:col-span-12 xl:col-span-12 2xl:col-span-12">
                                <div className="flex flex-row bg-white shadow-sm rounded p-4">
                                    ...
                                    <div className="flex flex-col  ml-4">
                                        ...
                                        <div className=" text-[#fff] font-mont text-[16px]">booking@buzzway.in</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        xmd:px-[92px] md:px-[92px] xsm:px-[0px] sm:px-[0px] xl:px-[0px] 2xl:px-[0px]">
                            <div className="mx-auto">
                                <div className="flex flex-col text-center w-full mb-12">
                                    <h1 className="lg:text-4xl  xmd:text-4xl  md:text-4xl xsm:text-4xl sm:text-3xl lg:text-4xl 
                                    ...
                                    <div className="flex flex-wrap -m-2">
                                        <div className="p-2 w-1/2">
                                            <div className="relative">
                                                <input type="text" name="name" className="w-full rounded py-5 px-3 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]" placeholder='Your Name' />
                                            </div>
                                        </div>
                                        <div className="p-2 w-1/2">
                                            <div className="relative">
                                                <input type="tel" placeholder='Enter Contact Number' className="w-full rounded py-5 px-3 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]" />
                                            </div>
                                        </div>
                                        <div className="p-2 w-full">
                                            <div className="relative">
                                                <input type="email" placeholder='Email Adreess' className="w-full rounded py-5 px-3 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] " />
                                            </div>
                                        </div>
                                        <div className="p-2 w-full">
                                            <div className="relative">
                                                <textarea name="message" placeholder='Your Message' className="w-full rounded py-5 px-3 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]" ></textarea>
                                            </div>
                                        </div>
                                        <div className="p-2 w-full">
                                            <button className="flex mx-auto text-[] bg-yellow py-3 px-10 font-[600] text-[20px] shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">Send Now</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
