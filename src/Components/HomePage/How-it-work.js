    ...
    return (
        <div className="text-gray-700 text-base">
            <div id="some-box" className="bg-white font-sans">
                <div className=' lg:mx-auto xmd:mx-auto md:mx-10 xsm:mx-10 max-w-screen-md py-12'>
                    <h1 className='text-[30px] font-[600] font-mont text-animation fade'>How It Works </h1>
